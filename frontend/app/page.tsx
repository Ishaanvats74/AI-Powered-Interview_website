...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const checkUser = async () => {
      try {
        ...
        await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/check-user`, {
          method: "POST",
          headers: {
  ...
  const handleStart = () => {
    router.push(isSignedIn ? "/uploadResume" : "/sign-up");
  };
    ...
    <div className="relative">
        ...
        <div className="grid items-center gap-16 lg:grid-cols-2">
          <div>
            ...
            <h1 className="mt-8 text-5xl font-bold leading-tight md:text-7xl">
              Ace Your Next
              <span className="block text-indigo-500">Technical Interview</span>
            </h1>

            <p className="mt-6 max-w-xl text-lg text-muted-foreground">
              Upload your resume, practice realistic AI interviews, and receive
              detailed feedback to improve your confidence, communication, and
      ...
      <section className="px-6 py-24">
        <div className="mx-auto max-w-5xl rounded-3xl border border-border bg-card p-16 text-center">
          <h2 className="text-5xl font-bold">Ready To Get Interview Ready?</h2>

          <p className="mt-6 text-muted-foreground">
            Practice with AI and improve your chances of landing your next
            opportunity.
          </p>
